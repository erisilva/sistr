              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td colspan="2" style = "text-align: center;">
                        ...
                        <div id="terminoMinutas">{{ (isset($tr->terminoMinutas)) ? $tr->terminoMinutas->format('d/m/Y') : '-'}}</div>
                    </td>
                    <td colspan="2" style = "text-align: center;">
                        <label for="inicioMinutasARP"><strong>Início minuta ARP</strong></label>
                        <div id="inicioMinutasARP">{{ (isset($tr->inicioMinutasARP)) ? $tr->inicioMinutasARP->format('d/m/Y') : '-'}}</div>
                    </td>
                    <td colspan="2" style = "text-align: center;">
