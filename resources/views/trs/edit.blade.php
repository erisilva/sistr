...
@section('content')
        ...
        <form method="POST" action="{{ route('trs.update', $tr->id) }}">
            ...
            <div class="form-row">
                <div class="form-group col-md-5">
                    ...
                    <input type="text" class="form-control" name="sei" id="sei" value="{{ $tr->sei }}">
                </div>
            </div>
            <div class="form-row">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control{{ $errors->has('descricao') ? ' is-invalid' : '' }}" name="descricao"
                    id="descricao" rows="2">{{ $tr->descricao }}</textarea>
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" name="quantidadeItens" id="quantidadeItens"
                        value="{{ $tr->quantidadeItens }}">
                </div>
                <div class="form-group col-md-4">
                    <label for="entregueSupAdm">Entrada na S.A. </label>
                    <input type="text" class="form-control" name="entregueSupAdm" id="entregueSupAdm"
                        value="{{ isset($tr->entregueSupAdm) ? $tr->entregueSupAdm->format('d/m/Y') : '' }}"
                        autocomplete="off">
                </div>
                <div class="form-group col-md-4">
                    <label for="entregueComprasContrato">Entrada DCC </label>
                    <input type="text" class="form-control" name="entregueComprasContrato" id="entregueComprasContrato"
                        value="{{ isset($tr->entregueComprasContrato) ? $tr->entregueComprasContrato->format('d/m/Y') : '' }}"
                        autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" name="inicioCotacao" id="inicioCotacao"
                        value="{{ isset($tr->inicioCotacao) ? $tr->inicioCotacao->format('d/m/Y') : '' }}"
                        autocomplete="off">
                </div>
                <div class="form-group col-md-4">
                    <label for="terminoCotacao">Término cotação </label>
                    <input type="text" class="form-control" name="terminoCotacao" id="terminoCotacao"
                        value="{{ isset($tr->terminoCotacao) ? $tr->terminoCotacao->format('d/m/Y') : '' }}"
                        autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" name="requisicaoCompras" id="requisicaoCompras"
                        value="{{ $tr->requisicaoCompras }}">
                </div>
                <div class="form-group col-md-3">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" name="envioSuplanPro" id="envioSuplanPro"
                        value="{{ isset($tr->envioSuplanPro) ? $tr->envioSuplanPro->format('d/m/Y') : '' }}"
                        autocomplete="off">
                </div>
                <div class="form-group col-md-3">
                    <label for="retornoSuplanPro">Retorno SUPLAN </label>
                    <input type="text" class="form-control" name="retornoSuplanPro" id="retornoSuplanPro"
                        value="{{ isset($tr->retornoSuplanPro) ? $tr->retornoSuplanPro->format('d/m/Y') : ''}}"
                        autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" name="protocoloSisprot" id="protocoloSisprot"
                        value="{{ $tr->protocoloSisprot }}">
                </div>
                <div class="form-group col-md-3">
                    <label for="envioCCOAF">Envio CCOAF </label>
                    <input type="text" class="form-control" name="envioCCOAF" id="envioCCOAF"
                        value="{{ isset($tr->envioCCOAF) ? $tr->envioCCOAF->format('d/m/Y') : '' }}" autocomplete="off">
                </div>
                <div class="form-group col-md-3">
                    <label for="retornoCCOAF">Retorno CCOAF </label>
                    <input type="text" class="form-control" name="retornoCCOAF" id="retornoCCOAF"
                        value="{{ isset($tr->retornoCCOAF) ? $tr->retornoCCOAF->format('d/m/Y') : '' }}" autocomplete="off">
                </div>
                <div class="form-group col-md-3">
                    ...
                    <select class="form-control" id="deliberacao_id" name="deliberacao_id">
                        <option value="{{$tr->deliberacao_id}}" selected="true">&rarr; {{ $tr->deliberacao->descricao }}
                        </option>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <select class="form-control" id="modalidade_id" name="modalidade_id">
                        <option value="{{$tr->modalidade_id}}" selected="true">&rarr; {{ $tr->modalidade->descricao }}
                        </option>
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" name="numeroModalidade" id="numeroModalidade"
                        value="{{ $tr->numeroModalidade }}">
                </div>
                <div class="form-group col-md-4">
                    <label for="autuacao">Autuação PAC </label>
                    <input type="text" class="form-control" name="autuacao" id="autuacao"
                        value="{{ isset($tr->autuacao) ? $tr->autuacao->format('d/m/Y') : '' }}" autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="inicioMinutas" id="inicioMinutas"
                        value="{{ isset($tr->inicioMinutas) ? $tr->inicioMinutas->format('d/m/Y') : '' }}"
                        autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                    <label for="terminoMinutas">Término minuta (contrato/aditivo) </label>
                    <input type="text" class="form-control" name="terminoMinutas" id="terminoMinutas"
                        value="{{ isset($tr->terminoMinutas) ? $tr->terminoMinutas->format('d/m/Y') : '' }}"
                        autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" name="inicioMinutasARP" id="inicioMinutasARP"
                        value="{{ isset($tr->inicioMinutasARP) ? $tr->inicioMinutasARP->format('d/m/Y') : '' }}"
                        autocomplete="off">
                </div>
                <div class="form-group col-md-4">
                    <label for="terminoMinutasARP">Término minuta ARP </label>
                    <input type="text" class="form-control" name="terminoMinutasARP" id="terminoMinutasARP"
                        value="{{ isset($tr->terminoMinutasARP) ? $tr->terminoMinutasARP->format('d/m/Y') : '' }}"
                        autocomplete="off">
                </div>
                <div class="form-group col-md-4">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="inicioMinutasEdital" id="inicioMinutasEdital"
                        value="{{ isset($tr->inicioMinutasEdital) ? $tr->inicioMinutasEdital->format('d/m/Y') : '' }}"
                        autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                    <label for="terminoMinutasEdital">Término minuta Edital </label>
                    <input type="text" class="form-control" name="terminoMinutasEdital" id="terminoMinutasEdital"
                        value="{{ isset($tr->terminoMinutasEdital) ? $tr->terminoMinutasEdital->format('d/m/Y') : '' }}"
                        autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="envioPgm" id="envioPgm"
                        value="{{ isset($tr->envioPgm) ? $tr->envioPgm->format('d/m/Y') : '' }}" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                    <label for="retornoPgm">Retorno PGM </label>
                    <input type="text" class="form-control" name="retornoPgm" id="retornoPgm"
                        value="{{ isset($tr->retornoPgm) ? $tr->retornoPgm->format('d/m/Y') : '' }}" autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="inicioSaneamentoPendencias"
                        id="inicioSaneamentoPendencias"
                        value="{{ isset($tr->inicioSaneamentoPendencias) ? $tr->inicioSaneamentoPendencias->format('d/m/Y') : '' }}"
                        autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                    <label for="terminoSaneamentoPendencias">Término Saneamento Pendências </label>
                    <input type="text" class="form-control" name="terminoSaneamentoPendencias"
                        id="terminoSaneamentoPendencias"
                        value="{{ isset($tr->terminoSaneamentoPendencias) ? $tr->terminoSaneamentoPendencias->format('d/m/Y') : '' }}"
                        autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" name="numeroEdital" id="numeroEdital"
                        value="{{ $tr->numeroEdital }}">
                </div>
                <div class="form-group col-md-4">
                    <label for="dataPregao">Data PREGÃO </label>
                    <input type="text" class="form-control" name="dataPregao" id="dataPregao"
                        value="{{ isset($tr->dataPregao) ? $tr->dataPregao->format('d/m/Y') : '' }}" autocomplete="off">
                </div>
                <div class="form-group col-md-4">
                    <label for="impugnacao">Impugnação / Suspensão </label>
                    <input type="text" class="form-control" name="impugnacao" id="impugnacao"
                        value="{{ isset($tr->impugnacao) ? $tr->impugnacao->format('d/m/Y') : '' }}" autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="inicioAnaliseTecnica" id="inicioAnaliseTecnica"
                        value="{{ isset($tr->inicioAnaliseTecnica) ? $tr->inicioAnaliseTecnica->format('d/m/Y') : '' }}"
                        autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                    <label for="terminoAnaliseTecnica">Término Análise Técnica </label>
                    <input type="text" class="form-control" name="terminoAnaliseTecnica" id="terminoAnaliseTecnica"
                        value="{{ isset($tr->terminoAnaliseTecnica) ? $tr->terminoAnaliseTecnica->format('d/m/Y') : '' }}"
                        autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" name="dataHomologacao" id="dataHomologacao"
                        value="{{ isset($tr->dataHomologacao) ? $tr->dataHomologacao->format('d/m/Y') : '' }}"
                        autocomplete="off">
                </div>
                <div class="form-group col-md-4">
                    <label for="dataRatificacao">Ratificação </label>
                    <input type="text" class="form-control" name="dataRatificacao" id="dataRatificacao"
                        value="{{ isset($tr->dataRatificacao) ? $tr->dataRatificacao->format('d/m/Y') : '' }}"
                        autocomplete="off">
                </div>
                <div class="form-group col-md-4">
                    <label for="dataReratificacao">Reratificação </label>
                    <input type="text" class="form-control" name="dataReratificacao" id="dataReratificacao"
                        value="{{ isset($tr->dataReratificacao) ? $tr->dataReratificacao->format('d/m/Y') : '' }}"
                        autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="formalizacaoContratoArp" id="formalizacaoContratoArp"
                        value="{{ isset($tr->formalizacaoContratoArp) ? $tr->formalizacaoContratoArp->format('d/m/Y') : ''  }}"
                        autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                    <label for="dataContratoArp">Data (contrato/aditivo/ARP) </label>
                    <input type="text" class="form-control" name="dataContratoArp" id="dataContratoArp"
                        value="{{ isset($tr->dataContratoArp) ? $tr->dataContratoArp->format('d/m/Y') : '' }}"
                        autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" name="datacadastro"
                        value="{{ $tr->created_at->format('d/m/Y') }}" readonly>
                </div>
                <div class="form-group col-md-3">
                    <label for="horacadastro">Hora de Cadastro </label>
                    <input type="text" class="form-control" name="horacadastro" value="{{ $tr->created_at->format('H:i') }}"
                        readonly>
                </div>
                <div class="form-group col-md-6">
    ...
    <div class="container">
        <div class="float-right">
            <a href="{{ route('trs.index') }}" class="btn btn-secondary btn-sm" role="button"><i
                    class="bi bi-arrow-left-square"></i> Voltar</i></a>
        </div>
    </div>

    @can('tr-edit-numero-ano')
        <!-- Janela para alterar a numeração do TR-->
        <div class="modal fade" id="modalTrocarNumero" tabindex="-1" role="dialog" aria-labelledby="JanelaFiltro"
            aria-hidden="true">
                        ...
                        <form method="POST" action="{{ route('trs.editnumber', $tr) }}">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="numero_edit" name="numero_edit"
                                        value="{{ $tr->numero }}">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="ano_edit">Ano</label>
                                    <input type="text" class="form-control" id="ano_edit" name="ano_edit"
                                        value="{{ $tr->ano }}">
                                </div>
                            </div>
