        ...
        <form method="POST" action="{{ route('trs.store') }}">
                ...
                <div class="form-group col-md-4">
                    ...
                    <select class="form-control" id="tipo_id" name="tipo_id">
                        ...
                        @foreach($tipos as $tipo)
                            <option value="{{$tipo->id}}" {{ old("tipo_id") == $tipo->id ? "selected" : "" }}>{{$tipo->descricao}}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control{{ $errors->has('descricao') ? ' is-invalid' : '' }}" name="descricao"
                    id="descricao" rows="2">{{ old('descricao') ?? '' }}</textarea>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" name="entregueComprasContrato" id="entregueComprasContrato"
                        value="{{ old('entregueComprasContrato') ?? '' }}" autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" name="envioSuplanPro" id="envioSuplanPro"
                        value="{{ old('envioSuplanPro') ?? '' }}" autocomplete="off">
                </div>
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" name="retornoSuplanPro" id="retornoSuplanPro"
                        value="{{ old('retornoSuplanPro') ?? '' }}" autocomplete="off">
                </div>
            </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <select class="form-control" id="deliberacao_id" name="deliberacao_id">
                        ...
                        @foreach($deliberacaos as $deliberacao)
                            <option value="{{$deliberacao->id}}" {{ old("deliberacao_id") == $deliberacao->id ? "selected" : "" }}>
                                {{$deliberacao->descricao}}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-row">
                <div class="form-group col-md-2">
                    ...
                    <input type="text" class="form-control" name="numeroPAC" id="numeroPAC"
                        value="{{ old('numeroPAC') ?? '' }}">
                </div>
                <div class="form-group col-md-3">
                    ...
                    <select class="form-control" id="modalidade_id" name="modalidade_id">
                        ...
                        @foreach($modalidades as $modalidade)
                            <option value="{{$modalidade->id}}" {{ old("modalidade_id") == $modalidade->id ? "selected" : "" }}>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="inicioMinutas" id="inicioMinutas"
                        value="{{ old('inicioMinutas') ?? '' }}" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="terminoMinutas" id="terminoMinutas"
                        value="{{ old('terminoMinutas') ?? '' }}" autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" name="inicioMinutasARP" id="inicioMinutasARP"
                        value="{{ old('inicioMinutasARP') ?? '' }}" autocomplete="off">
                </div>
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" name="terminoMinutasARP" id="terminoMinutasARP"
                        value="{{ old('terminoMinutasARP') ?? '' }}" autocomplete="off">
                </div>
                <div class="form-group col-md-4">
                    ...
                    <select class="form-control" id="pregoeiro_id" name="pregoeiro_id">
                        ...
                        @foreach($pregoeiros as $pregoeiro)
                            <option value="{{$pregoeiro->id}}" {{ old("pregoeiro_id") == $pregoeiro->id ? "selected" : "" }}>
                                {{$pregoeiro->nome}}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="inicioMinutasEdital" id="inicioMinutasEdital"
                        value="{{ old('inicioMinutasEdital') ?? '' }}" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="terminoMinutasEdital" id="terminoMinutasEdital"
                        value="{{ old('terminoMinutasEdital') ?? '' }}" autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="inicioSaneamentoPendencias"
                        id="inicioSaneamentoPendencias" value="{{ old('inicioSaneamentoPendencias') ?? '' }}"
                        autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="terminoSaneamentoPendencias"
                        id="terminoSaneamentoPendencias" value="{{ old('terminoSaneamentoPendencias') ?? '' }}"
                        autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="inicioAnaliseTecnica" id="inicioAnaliseTecnica"
                        value="{{ old('inicioAnaliseTecnica') ?? '' }}" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="terminoAnaliseTecnica" id="terminoAnaliseTecnica"
                        value="{{ old('terminoAnaliseTecnica') ?? '' }}" autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" name="dataReratificacao" id="dataReratificacao"
                        value="{{ old('dataReratificacao') ?? '' }}" autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="formalizacaoContratoArp" id="formalizacaoContratoArp"
                        value="{{ old('formalizacaoContratoArp') ?? '' }}" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="dataContratoArp" id="dataContratoArp"
                        value="{{ old('dataContratoArp') ?? '' }}" autocomplete="off">
                </div>
            </div>

            <div class="form-group">
                <label for="publicacao">PUBLICAÇÃO DOC </label>
                <textarea class="form-control" name="publicacao" id="publicacao"
                    rows="3">{{ old('publicacao') ?? '' }}</textarea>
            </div>
