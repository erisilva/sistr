...
<div class="container">
  @if(Session::has('edited_tipo'))
  <div class="alert alert-warning alert-dismissible fade show" role="alert">
    <strong>Info!</strong>  {{ session('edited_tipo') }}
  ...
  <form method="POST" action="{{ route('tipos.update', $tipo->id) }}">
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control{{ $errors->has('descricao') ? ' is-invalid' : '' }}" name="descricao" value="{{ old('descricao') ?? $tipo->descricao }}">
