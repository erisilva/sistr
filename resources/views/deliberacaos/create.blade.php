...
<div class="container">
  <form method="POST" action="{{ route('deliberacaos.store') }}">
    @csrf
    <div class="form-row">
  ...
  <div class="float-right">
    <a href="{{ route('deliberacaos.index') }}" class="btn btn-secondary btn-sm" role="button"><i class="fas fa-long-arrow-alt-left"></i> Voltar</i></a>
  </div>
</div>
@endsection
