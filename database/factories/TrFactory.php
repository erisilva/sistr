...
class TrFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'terminoMinutas' => $this->faker->date($format = 'Y-m-d', $max = 'now'),
            'inicioMinutasARP' => $this->faker->date($format = 'Y-m-d', $max = 'now'), 
            'terminoMinutasARP' => $this->faker->date($format = 'Y-m-d', $max = 'now'),
            ...
            'dataReratificacao' => $this->faker->date($format = 'Y-m-d', $max = 'now'), 
